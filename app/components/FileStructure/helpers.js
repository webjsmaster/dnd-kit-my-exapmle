...
import {ReactComponent as IconFolderClosed} from '@/app/components/FileStructure/img/folder-closed.svg'
import {ReactComponent as IconFolderOpened} from '@/app/components/FileStructure/img/folder-opened.svg'
import svg, {ReactComponent as IconArrowClosed} from '@/app/components/FileStructure/img/arrow-closed.svg'
import {ReactComponent as IconArrowOpened} from '@/app/components/FileStructure/img/arrow-opened.svg'
import {ReactComponent as IconCameraEnabled} from '@/app/components/FileStructure/img/camera-enabled.svg'
import {ReactComponent as IconCameraDisabled} from '@/app/components/FileStructure/img/camera-disabled.svg'
import {ReactComponent as IconEventsGroup} from '@/app/components/FileStructure/img/events-group.svg'
import {ReactComponent as IconRealtime} from '@/app/components/FileStructure/img/realtime.svg'
...
export const getIcon = (type) => {
    switch (type) {
        ...
        case 'arrow_closed':
            return <IconArrowClosed/>
        case 'arrow_opened':
            return <IconArrowOpened/>
        case 'camera':
            return <IconCameraDisabled/>
        case 'camera_enabled':
            return <IconCameraEnabled/>
        case 'events_group':
            return <IconEventsGroup/>
        case 'realtime':
            return <IconRealtime/>
        default:
            return svg
